    ...
    try {
      ...
      setFlatItems(prev => {
        ...
        const childFlatItems: FlatTreeItem[] = sortedChildren.map(child => ({
          ...
          val_unknown_count: child.val_unknown_count,
          val_valid_count: child.val_valid_count,
          val_invalid_count: child.val_invalid_count,
          val_no_validator_count: child.val_no_validator_count,
          hash_unknown_count: child.hash_unknown_count,
          hash_valid_count: child.hash_valid_count,
          hash_suspect_count: child.hash_suspect_count,
          depth: parentDepth + 1,
          isExpanded: false,
          childrenLoaded: false,
