    ...
    pub fn append_changes_row(
        ...
        for col in &self.show().display_cols {
            ...
            let col_string = match col.display_col {
                ...
                "file_size_old" => Format::format_opt_i64(change.file_size_old),
                "file_size_new" => Format::format_opt_i64(change.file_size_new),
...
pub struct ChangesQueryRow {
    ...
    pub file_size_old: Option<i64>,
    pub file_size_new: Option<i64>,
