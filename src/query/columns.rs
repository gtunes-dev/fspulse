...
pub const SCANS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "total_file_size" => ColSpec::new("total_file_size", "Total Size", true, ColType::Int, ColAlign::Right),
...
pub const ITEMS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "file_size" => ColSpec::new("file_size", "File Size", false, ColType::Int, ColAlign::Right),
...
pub const CHANGES_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "file_size_old" => ColSpec::new("file_size_old", "File Size Old", false, ColType::Int, ColAlign::Right),
    "file_size_new" => ColSpec::new("file_size_new", "File Size New", false, ColType::Int, ColAlign::Right),
