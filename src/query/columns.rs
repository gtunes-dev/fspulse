...
pub const CHANGES_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "file_size_old" => ColSpec::new("file_size_old", "File Size Old", false, true, ColType::Int, ColAlign::Right),
    "file_size_new" => ColSpec::new("file_size_new", "File Size New", false, true, ColType::Int, ColAlign::Right),
