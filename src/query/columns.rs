...
pub const SCANS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "scan_state" => ColSpec::new("state", "State", true, ColType::ScanState, ColAlign::Center),
...
pub const ITEMS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "item_name" => ColSpec::new("i.item_name", "Item Name", true, ColType::Path, ColAlign::Left),
    "file_extension" => ColSpec::new("i.file_extension", "Extension", true, ColType::String, ColAlign::Left),
    "item_type" => ColSpec::new("i.item_type", "Type", true, ColType::ItemType, ColAlign::Center),
    "has_validator" => ColSpec::new("i.has_validator", "Has Validator", false, ColType::Bool, ColAlign::Center),
    "do_not_validate" => ColSpec::new("i.do_not_validate", "Do Not Validate", false, ColType::Bool, ColAlign::Center),
};
...
pub const VERSIONS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "file_extension" => ColSpec::new("i.file_extension", "Extension", false, ColType::String, ColAlign::Left),
    "item_type" => ColSpec::new("i.item_type", "Type", true, ColType::ItemType, ColAlign::Center),
    ...
    "is_added" => ColSpec::new("iv.is_added", "Added", false, ColType::Bool, ColAlign::Center),
    "is_deleted" => ColSpec::new("iv.is_deleted", "Deleted", true, ColType::Bool, ColAlign::Center),
    "is_current" => ColSpec::new("(iv.first_scan_id = (SELECT MAX(first_scan_id) FROM item_versions WHERE item_id = iv.item_id))", "Current", false, ColType::Bool, ColAlign::Center),
    ...
    "size" => ColSpec::new("iv.size", "Size", true, ColType::Int, ColAlign::Right),
...
pub const HASHES_QUERY_COLS: ColMap = phf_ordered_map! {
    "item_id" => ColSpec::new("hv.item_id", "Item Id", true, ColType::Id, ColAlign::Right),
    "item_version" => ColSpec::new("hv.item_version", "Version", true, ColType::Id, ColAlign::Right),
    "item_path" => ColSpec::new("i.item_path", "Item Path", true, ColType::Path, ColAlign::Left),
    "item_name" => ColSpec::new("i.item_name", "Item Name", false, ColType::Path, ColAlign::Left),
    "first_scan_id" => ColSpec::new("hv.first_scan_id", "First Scan", true, ColType::Id, ColAlign::Right),
    "last_scan_id" => ColSpec::new("hv.last_scan_id", "Last Scan", true, ColType::Id, ColAlign::Right),
    "file_hash" => ColSpec::new("hv.file_hash", "File Hash", true, ColType::Hash, ColAlign::Left),
    "hash_state" => ColSpec::new("hv.hash_state", "Hash State", true, ColType::HashState, ColAlign::Center),
};
