...
pub const ITEMS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "val_state" => ColSpec::new("vv.val_state", "Val State", false, ColType::ValState, ColAlign::Center),
    "val_error" => ColSpec::new("vv.val_error", "Val Error", false, ColType::String, ColAlign::Left),
    "file_hash" => ColSpec::new("hv.file_hash", "File Hash", false, ColType::Hash, ColAlign::Left),
