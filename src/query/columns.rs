...
pub const CHANGES_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "root_id" => ColSpec::new("items_old.root_id", "Root Id", true, ColType::Id, ColAlign::Right),
    ...
    "item_path" => ColSpec::new("items_old.item_path", "Item Path", false, ColType::Path, ColAlign::Left),
...
pub const ALERTS_QUERY_COLS: ColMap = phf_ordered_map! {
    ...
    "item_path" => ColSpec::new("items_old.item_path", "Item Path", true, ColType::Path, ColAlign::Left),
