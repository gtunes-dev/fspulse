...
use v30_to_v31::{migrate_v30_to_v31, UPGRADE_30_TO_31_PRE_SQL};
use v31_to_v32::migrate_v31_to_v32;
...
pub const MIGRATION_20_TO_21: Migration = Migration::Transacted {
    pre_sql: Some(UPGRADE_20_TO_21_PRE_SQL),
...
pub const MIGRATION_27_TO_28: Migration = Migration::standalone(migrate_v27_to_v28);
...
pub const MIGRATION_30_TO_31: Migration = Migration::Transacted {
    pre_sql: Some(UPGRADE_30_TO_31_PRE_SQL),
    code_fn: Some(migrate_v30_to_v31),
    post_sql: None,
};
pub const MIGRATION_31_TO_32: Migration = Migration::standalone(migrate_v31_to_v32);
